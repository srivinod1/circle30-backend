...
tools = [
    StructuredTool.from_function(
        func=lambda city: query_zip_scores.invoke({"city": city}),
    ...
    StructuredTool.from_function(
        func=lambda zipcode: get_zip_details.invoke({"zipcode": zipcode}),
...
if __name__ == "__main__":
    # Example queries
    queries = [
        "What are the top 3 EV underserved zip codes in Austin relative to the geography size and population size?"
    ]
